...
private let trendDays: Int = 30
private let trendChartHeight: CGFloat = 80
private let trendBarGap: CGFloat = 2
private let trendBarWidth: CGFloat = 8
...
struct HeatmapSection: View {
    ...
    var body: some View {
        ...
        .onChange(of: store.selectedProvider) { _ in ensureValidSelection() }
    }
...
private struct OptimizeSavingsBadge: View {
    ...
    @MainActor private func captionText(findingCount: Int, savingsUSD: Double) -> String {
